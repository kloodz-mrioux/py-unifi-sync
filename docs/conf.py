...
#extlinks = {'doi': ('http://dx.doi.org/%s', 'doi:')} to extlinks = {'doi': ('http://dx.doi.org/%s', 'doi:%s')}
...
html_theme_options = {
    ...
    "github_user": f"{UnifiSyncClient.__git_repouser__}",
    "github_repo": f"{UnifiSyncClient.__git_reponame__}",
    "github_banner": True,
    "show_related": False,
    "note_bg": "#FFF59C",
}
...
latex_documents = [
    (master_doc, "Requests.tex", u"Requests Documentation", [author], "manual")
]
